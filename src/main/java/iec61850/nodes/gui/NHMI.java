...
/**
 * @description Node for plotting graphs (time sequences)
 */
public class NHMI extends LN {
	 ...
	 * @param name - name of the signal group
	 * @param signals - signal group
	 */
...
//		rangeAxis.setLabelFont(new Font("Impact", Font.ITALIC, 10));
		...
		/* Add a differential if there is a discrete */
